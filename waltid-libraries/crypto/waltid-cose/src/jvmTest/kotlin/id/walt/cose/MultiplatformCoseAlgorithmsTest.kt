...
class MultiplatformCoseAlgorithmsTest {

    val multiplatformKeyTypes = listOf(KeyType.secp256r1, KeyType.RSA, KeyType.RSA3072, KeyType.RSA4096)

    @Test
    fun testAllCoseAlgorithms() = runTest {
        multiplatformKeyTypes.forEachIndexed { idx, keyType ->
            println("> [Multiplatform]: Testing key type $idx: $keyType")
