<template>
    <div class="flex flex-col w-full items-center justify-between space-x-3 p-6">
        ...
        <div class="flex-1 truncate w-full">
            ...
            <!-- nft-description -->
            <p class="mt-1 text-sm text-gray-500 flex flex-row items-center">
                <span class="scrollbar-hide w-5/6"><span class="font-mono">Description</span>: {{ nft.description
                    }}</span>
            </p>
            <!-- nft-holder -->
            <p class="mt-1 text-sm text-gray-500 flex flex-row items-center">
                <span class="scrollbar-hide w-5/6"><span class="font-mono">Owner</span>:
                    <cryptoAddress :text="owner.address" />
                </span>
            </p>
            <!-- redeemed-status -->
