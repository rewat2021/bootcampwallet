...
class PresentationDefinitionPolicyTests(private val e2e: E2ETest) {
    ...
    private var client: HttpClient = WaltidServicesIntegrationTests.testHttpClient()
    ...
    private suspend fun loginWallet() {
        client.post("/wallet-api/auth/login") {
            ...
            .body<JsonObject>()
            .let {
                client = WaltidServicesIntegrationTests.testHttpClient(token = it["token"]!!.jsonPrimitive.content)
            }
    }
