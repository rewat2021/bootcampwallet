...
class VerifierPresentedCredentialsTests(val e2e: E2ETest) {
    ...
    private suspend fun presentUniDegreeNoDisclosures() =
        e2e.test(
            ...
            assertEquals(jwtVcJsonPresentationSimpleView.verifiableCredentials.size, 1)
            ...
            assertEquals(jwtVcJsonPresentationVerboseView.verifiableCredentials.size, 1)
    ...
    private suspend fun presentSdJwtVc() =
        e2e.test(
            ...
            assertTrue(sdJwtVcPresentationVerboseView.raw.isNotBlank())
            assertNotNull(sdJwtVcPresentationVerboseView.keyBinding)

            assertTrue(sdJwtVcPresentationVerboseView.vc.fullPayload != sdJwtVcPresentationVerboseView.vc.undisclosedPayload)
            ...
            assertEquals(disclosures.size, 2)
    ...
    private suspend fun presentMdl() =
        e2e.test(
            ...
            assertEquals(msoMdocPresentationVerboseView.documents.size, 1)
            ...
            assertEquals(mDoc.issuerSigned.nameSpaces.size, 1)
    ...
    private suspend fun presentOpenBadgeWithDisclosures() =
        e2e.test(
            ...
            assertTrue(verboseCredential.fullPayload != verboseCredential.undisclosedPayload)
    ...
    private suspend fun presentUniDegreeOpenBadgeWithDisclosures() =
        e2e.test(
            ...
            assertEquals(jwtVcJsonPresentationSimpleView.verifiableCredentials.size, 2)
            ...
            assertEquals(jwtVcJsonPresentationVerboseView.verifiableCredentials.size, 2)
